            ...
            <div class="col-md-3 left_col menu_fixed">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?php echo site_url('Auth/dokter'); ?>" class="site_title"><i class="fa fa-plus-square"></i> <span>Dashboard Dokter</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="<?php echo site_url('Dokter/pemeriksaan'); ?>"><i class="fa fa-stethoscope"></i>Pemeriksaan</a>

                                </li>
                                <li><a href="<?php echo site_url('Dokter/resep_obat'); ?>"><i class="fa fa-flask"></i>Resep Obat</a>
