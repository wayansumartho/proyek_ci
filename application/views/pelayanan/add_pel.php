			    ...
			    <div class="">
			        ...
			        <div class="row">
			            <div class="col-md-12 col-sm-12 ">
			                <div class="x_panel">
			                    <div class="x_title">
			                        <h2>Halaman Tambah Pelayanan</h2>

			                        <div class="clearfix"></div>
			                    </div>
			                    <div class="x_content">
			                        <br />
			                        <form method="POST" action="<?php echo site_url('Pelayanan/aksi_simpan'); ?>">
			                            ...
			                            <div class="item form-group">
			                                ...
			                                <div class="col-md-6 col-sm-6 ">
			                                    <input type="text" id="last-name" name="harga" placeholder="Masukan Username" required="required" class="form-control">
			                                </div>
			                            </div>
